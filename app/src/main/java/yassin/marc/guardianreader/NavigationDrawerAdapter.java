...
//        TextView email;
        ...
        public ViewHolder(View itemView,int ViewType, Context viewHolderContext) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            super(itemView);
            mContext = viewHolderContext;
...
//                profile = (ImageView) itemView.findViewById(R.id.circleView);// Creating Image view object from header.xml for profile pic
    ...
    NavigationDrawerAdapter(String Titles[],int Icons[],String Name, Context passedContext){//},String Email, int Profile){ // MyAdapter Constructor with titles and icons parameter
